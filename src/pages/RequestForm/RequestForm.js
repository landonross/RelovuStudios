    ...
    <div className="min-h-screen bg-gray-800 pb-32">
      <main className="overflow-hidden">
        ...
        <section className="relative bg-gray-800" aria-labelledby="contact-heading">
          <div className="absolute w-full h-1/2 bg-gray-800" aria-hidden="true" />
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3">
                ...
                <div className="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                  ...
                  <form action="#" method="POST" className="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                    ...
                    <div>
                      <label htmlFor="last-name" className="block text-sm font-medium text-warm-gray-100">
                        Last name
                      </label>
                      <div className="mt-1">
                        <input
                    ...
                    <div>
                      <label htmlFor="email" className="block text-sm font-medium text-warm-gray-100">
                        Email
                      </label>
                      <div className="mt-1">
                        <input
                    ...
                    <div>
                      <div className="flex justify-between">
                        <label htmlFor="phone" className="block text-sm font-medium text-warm-gray-100">
                          Phone
                        </label>
                        <span id="phone-optional" className="text-sm text-warm-gray-400">
                          Optional
                        </span>
                      </div>
                      <div className="mt-1">
                    ...
                    <div className="sm:col-span-2">
                      <label htmlFor="subject" className="block text-sm font-medium text-warm-gray-100">
                        Subject
                      </label>
                      <div className="mt-1">
                        <input
                    ...
                    <div className="sm:col-span-2">
                      <div className="flex justify-between">
                        <label htmlFor="message" className="block text-sm font-medium text-warm-gray-100">
                          Message
                        </label>
                        <span id="message-max" className="text-sm text-warm-gray-400">
                          Max. 500 characters
                        </span>
                      </div>
                      <div className="mt-1">
